...
#include <sys/types.h>	//for msgget, fork
...
int main(int argc, char* argv[]){
	...
	if(argc!=4){
		perror("Insufficent number of inputs provided, provide k,m,f as command line arguments");
		exit(-1);
	}
	...
	*/
	...
	for(int i=0; i<k ; i++){
		...
		processPageMap[i].processId = Process_es[i];
